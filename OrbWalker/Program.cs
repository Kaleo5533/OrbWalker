...
namespace OrbWalker
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Press and hold '{(VirtualKeyCode)CurrentSettings.ActivationKeyMinions}' to activate the Orb Walker Minions");
            Console.WriteLine($"Press and hold '{(VirtualKeyCode)CurrentSettings.ActivationKeyEnemies}' to activate the Orb Walker Enemies");
            CheckLeagueProcess();
